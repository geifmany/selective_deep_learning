...
if __name__ == '__main__':
    ...
    bound_cal.bound(0.01,delta,kappa,residuals)
    bound_cal.bound(0.02,delta,kappa,residuals)
    bound_cal.bound(0.03,delta,kappa,residuals)
    bound_cal.bound(0.04,delta,kappa,residuals)
